  ...
  return (
    <DetailWrapper>
      <PoastWrapper>
        <TopContainer>
          <ProfileBox>
            <ProfileImg src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNL_ZnOTpXSvhf1UaK7beHey2BX42U6solRA&s" />
            <DataBox>
              <UserName>{data?.fetchBoard?.writer}</UserName>
              <UserDate>{data?.fetchBoard?.createdAt && formatDate}</UserDate>
            </DataBox>
          </ProfileBox>
          <ProfileRightBox>
            <LinkIcon>
        ...
        <PostContainer>
          ...
          <PostImg src="https://d2ijz6o5xay1xq.cloudfront.net/account_2263/tomorrowland_68ab5bc410883b4693d66fef5a37c410_800.jpg" />
          <PostContents>{data?.fetchBoard?.contents}</PostContents>
          {/* <PostVideo /> */}
          <ThumbBox>
            <ThumbUp>
              <ThumbBtn>
              ...
              <ThumbUpCount>1999</ThumbUpCount>
            </ThumbUp>
            <ThumbDown>
              <ThumbBtn>
                <svg
              ...
              <ThumbDownCount>914</ThumbDownCount>
            </ThumbDown>
          </ThumbBox>
        </PostContainer>
      </PoastWrapper>
      ...
      <ButtonBox>
        <ButtonBoxBtn>목록으로</ButtonBoxBtn>
        <ButtonBoxBtn>수정하기</ButtonBoxBtn>
        <ButtonBoxBtn>삭제하기</ButtonBoxBtn>
      </ButtonBox>
      ...
      <CommentContainer>
        ...
        <CommentForm>
          <CommentTopBox>
            <CommentWriterInput type="text" placeholder="작성자" />
            <CommentWriterInput type="text" placeholder="비밀번호" />
          </CommentTopBox>
          <CommentContents
            type="text"
